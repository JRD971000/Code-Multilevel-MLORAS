...
from pyamg.util import make_system
...
def fgmres_2L(A, b, x0=None, tol=1e-5,
           restrt=None, maxiter=None,
           M=None, grid=None, callback=None, residuals=None):
    ...
    for _outer in range(max_outer):
        ...
        A0_inv = np.linalg.inv(A0.toarray())
        ...
        for inner in range(max_inner):
            ...
            if grid != None:
                ...
                v = v + R0.transpose() @ (A0_inv @ (R0 @ (qq - grid.A @ v)))
...
def cg_2L(A, b, x0=None, tol=1e-5, criteria='rr',
       restrt=None, maxiter=None, M=None,
       grid = None, callback=None, residuals=None):
    ...
    if grid != None:
        ...
        z = M @ r
        z = z + R0.transpose() @ (A0_inv @ (R0 @ (r - A @ z)))
        z = z + M.transpose() @ (r - A @ z)
    else:
        z = M @ r
    p = z.copy()
